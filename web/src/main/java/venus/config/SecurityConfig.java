...
import venus.logic.filters.StatelessAuthenticationFilter;
import venus.logic.filters.StatelessLoginFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(
                new StatelessLoginFilter("/api/user/login", tokenAuthenticationService, userService, authenticationManager()),
